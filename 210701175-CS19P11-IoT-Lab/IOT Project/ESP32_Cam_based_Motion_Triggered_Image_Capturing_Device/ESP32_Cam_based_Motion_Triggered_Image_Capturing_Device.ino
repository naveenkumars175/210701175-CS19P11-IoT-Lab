...
#define WIFI_SSID             "Mukkundhan"
#define WIFI_PASSWORD         "mukku@2004"


#define emailSenderAccount    "210701170@rajalakshmi.edu.in"    //To use send Email for Gmail to port 465 (SSL), less secure app option should be enabled. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword   "aj65fdan"

#define emailRecipient        "210701170@rajalakshmi.edu.in"
...
void setup() 
{
  ...
  s->set_contrast(s, 0);    //min=-2, max=2
  s->set_brightness(s, 0);  //min=-2, max=2
  s->set_saturation(s, 0);  //min=-2, max=2
